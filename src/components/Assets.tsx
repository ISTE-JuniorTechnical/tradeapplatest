...
class Asset extends React.Component<PassedProps> {
    ...
    render() {
        return (
            <div>
                <nav className="level mt-2 mb-2">
                    <div className="level-item has-text-centered mt-5 mt-sm-0 ">
                        <div>
                            <p className="heading">Money</p>
                            <p className="title text-warning">$ {this.props.money.money}</p>
                        </div>
                    </div>
                    ...
                    <div className="level-item has-text-centered mt-5 mt-sm-0 ">
                        <div>
                            ...
                            <p className="title text-warning">$ {this.calcAsset()}</p>
                        </div>
                    </div>
                    ...
                    <div className="level-item has-text-centered mt-5 mt-sm-0 ">
                        <div>
                            ...
                            <p className="title text-warning">$ {RoundOf(this.props.money.money + this.calcAsset(), 2)}</p>
                        </div>
                    </div>
