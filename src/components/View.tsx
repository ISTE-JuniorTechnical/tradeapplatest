...
class View extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="container-fluid" id="search_box_view">
                <div className="field is-horizontal">
                    ...
                    <div className="field-item">
                        {this.state.loading ? <button className="button is-link is-loading btn-warning">Loading</button> :
                        <button className="button is-link bg-warning" onClick={this.handleClick} >Search</button>}
                    </div>
                </div>

                {_.isEmpty(this.state.quote) ? undefined : 
                    <div>
                        <ul className="view_list container-fluid">
                ...
                {(!this.state.dataLoad || _.isEmpty(this.state.quote)) ? undefined :
                    <div>
                        <h3 id="view_title" className="title has-text-centered historical mt-3 mx-auto">Hist. Data of {this.state.quote.companyName}</h3>
