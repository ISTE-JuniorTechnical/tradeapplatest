        ...
        return (
            <div className="field">
                    <div className="" id="sellGroup">
                        ...
                        <button className="button is-link is-small bg-warning text-dark rounded" onClick={() => this.handleSubmit(this.props.id, this.props.allValue.currPrice, this.props.allValue.quantity, this.props.allValue.buyPrice)} >SELL</button>
                    </div>
