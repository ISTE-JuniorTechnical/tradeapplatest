...
class Buy extends React.Component<any, State> {
    ...
    render() {
        return (
            <section className="section container-fluid mx-auto">
                <div className="mx-auto">

                    <h1 className="title is-3" > <span className="text-warning text-uppercase">Total Money Left : </span> <span className="is-pulled-right text-success">$ {this.props.money.money}</span> </h1>

                    <form onSubmit={this.handleSubmit}>
                        
                        <div className="field">
                            <label className="label text-warning">Symbol</label>
                        ...
                        <div className="field">
                            <label className="label text-warning">Quantity</label>
                            <div className="control">
                        ...
                        <div className="field">
                            <div className="control">
                            {this.state.loader ? <button className="button is-loading is-fullwidth" id = "buySubmit">Loading</button> : <button className="button text-warning btn-outline mx-auto is-fullwidth" >Submit</button> }
                            </div>
                        </div>
                    </form>
